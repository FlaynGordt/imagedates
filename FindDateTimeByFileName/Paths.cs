namespace FindStuff
{
    public static class Paths
    {
        ...
        public static string HTML_FILES_PATH = Path.Combine(SLIDYROOT, "HTML Slidy_files");
        public static string HTML_TEMPATE_PATH = Path.Combine(SLIDYROOT, "HTML Slidy.html");
